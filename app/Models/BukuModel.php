...
class BukuModel extends Model
{
	...
	protected $allowedFields = ['file_enc','slug_buku','author','judul_buku','penulis','penerbit','sampul','hastag','menu','size''type','deskripsi','download','reader','rating','status','pesan'];
	protected $db;
