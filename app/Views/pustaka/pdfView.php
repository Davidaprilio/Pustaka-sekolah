  ...
  <script type="text/javascript">
    ...
    alert('frame has (re)loaded ');
      ...
      function cekBaca() {
        setTimeout(function() {
          if (active) {
            ...
            $.ajax({ url: window.location.origin+'/Engine/upReadUser/'+param, type: 'get', dataType: 'ajax'});
            active = false;
            cekBaca();
          } else {
            ...
            if (conf) {
              ...
              $.ajax({ url: window.location.origin+'/Engine/endRead/'+param, type: 'get', dataType: 'ajax'});
      ...
      setTimeout(function() {
        ...
        cekBaca();
        $.ajax({ url: window.location.origin+'/Engine/startRead/'+param, type: 'get', dataType: 'ajax'});
        console.log('start');
      }, 180000);
    });
